        ...
        <div className='relative min-h-screen flex flex-col bg-gray-50'>
          ...
          <div className='flex-grow w-full max-w-5xl mx-auto lg:flex mt-7'>
            <div className='flex-1 min-w-0 bg-[#f9fafb] rounded-[10px] xl:flex mx-2 md:mx-0 lg:mx-0 xl:mx-0'>
              ...
              <div className={ChatId.chatId ? 'flex-1 p:2 justify-start sm:pb6 bg-white rounded-[10px] h-screen md:flex md:flex-col lg:flex lg:flex-col xl:flex xl:flex-col' : 'hidden'}>
                <Chat />
              </div>
