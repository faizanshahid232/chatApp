    ...
    return (
        <div className="flex">
            ...
            <span className=''>
                ...
                <span className=''>
                    <label htmlFor="upload-button" className="custom-file-upload cursor-pointer inline-flex items-center justify-center rounded-full h-12 w-12 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-300">
            ...
            <div className='relative flex'>
                ...
                <input 
                    ...
                    className='w-full focus:placeholder-gray-400 text-gray-600 placeholder-gray-300 pl-2 pr-[60px] bg-gray-100 rounded-lg py-3 border-gray-200' 
