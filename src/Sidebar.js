...
export default function Sidebar() {
    ...
    return(
        ...
        (<div className='h-[0px] border-b border-gray-200 xl:border-b-0 xl:flex-shrink-0 xl:w-68 bg-gray-50'>
            ...
            <div className={ChatId.chatId ? 'hidden rounded-bl-[10px] rounded-br-[10px] h-[545px] md:block lg:block xl:block md:h-full lg:h-full xl:h-full relative bg-white' : 'h-[400px] md:h-full lg:h-full xl:h-full relative bg-white'}>
